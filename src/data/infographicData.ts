...
import infographicBuuDienTrungTam from '../assets/images/infographic_buu_dien_trung_tam_1788871104704.jpg';
import infographicChoBenThanh from '../assets/images/infographic_cho_ben_thanh_1788871122865.jpg';
import infographicBenNhaRong from '../assets/images/infographic_ben_nha_rong_1788871140932.jpg';
...
export const PLACE_INFOGRAPHICS: Record<string, PlaceInfographicMeta> = {
  ...
  "BƯU ĐIỆN TRUNG TÂM SÀI GÒN": {
    placeName: "BƯU ĐIỆN TRUNG TÂM THÀNH PHỐ HỒ CHÍ MINH",
    category: "kien_truc",
    categoryTitle: "Không gian Kiến trúc & Tín ngưỡng",
    masterImage: infographicBuuDienTrungTam,
    yearEstablished: "1886 – 1891",
    architectOrOrigin: "KTS Marie-Alfred Foulhoux (thiết kế) • Gustave Eiffel (hệ kết cấu vòm sắt)",
    keyClassification: "Di tích Kiến trúc Nghệ thuật cấp Quốc gia",
    dimensionsOrScale: "Mặt tiền 60m vàng thổ hoàng, trần vòm cao 15.5m, 14 bốt điện thoại gỗ cổ & 2 bản đồ cổ 1892",
    ...
    milestones: [
      { year: "1886", event: "Khởi công xây dựng công trình bưu điện trung tâm quy mô lớn nhất Đông Dương thời bấy giờ" },
      { year: "1891", event: "Chính thức khánh thành và đưa vào vận hành mạng lưới bưu chính - viễn thông công cộng" },
      { year: "1892", event: "Hoàn tất 2 bức đại họa bản đồ lịch sử vẽ tay trên tường sảnh vòm: Bản đồ viễn thông Nam Kỳ và Sài Gòn xưa" },
      { year: "Hơn 130 năm", event: "Duy trì liên tục chức năng phục vụ bưu chính công cộng và đón hàng triệu du khách quốc tế mỗi năm" }
    ],
    visualHighlights: [
      "Mái vòm bán nguyệt lợp ngói được nâng đỡ bởi bốn trụ sắt đồ sộ uốn lượn phong cách Eiffel",
      "Hai bản đồ lịch sử vẽ tay đối xứng trên tường sảnh: 'Saigon et ses environs 1892' và 'Lignes télégraphiques 1892'",
      "Hàng 14 bốt điện thoại công cộng bằng gỗ tếch cổ điển lưu dấu kỷ nguyên thông tin liên lạc",
      "Hệ thống biển khắc tên các nhà bác học phát minh ngành điện năng và viễn thông (Ampère, Ohm, Volta, Morse, Faraday...)"
    ],
    keyDataPoints: [
      { label: "Năm khánh thành", value: "1891 (Khởi công 1886)" },
      { label: "Phong cách kiến trúc", value: "Phục Hưng kết hợp chi tiết Á Đông" },
      { label: "Kỹ sư kết cấu vòm sắt", value: "Gustave Eiffel" },
      { label: "Chiều cao trần vòm", value: "15.5 mét" },
      { label: "Màu sơn di sản", value: "Vàng thổ hoàng & cửa lục" }
    ],
    pedagogicalTakeaways: [
      "Nhận diện nét giao thoa văn hóa giữa kỹ thuật công nghiệp kim loại châu Âu thế kỷ XIX và mỹ thuật trang trí bản địa.",
      "Khai thác giá trị tư liệu khảo cứu của 2 bức bản đồ cổ 1892 về hệ thống bưu chính và địa lý Nam Kỳ xưa.",
      "Nâng cao ý thức bảo tồn các công trình di sản sống vẫn giữ trọn công năng phục vụ đời sống đô thị hiện đại."
    ]
  },
...
export const PLACE_MASTER_IMAGES: Record<string, string> = {
  "Bến Nhà Rồng": infographicBenNhaRong,
  ...
  "BƯU ĐIỆN TRUNG TÂM SÀI GÒN": infographicBuuDienTrungTam,
  "Bưu điện Trung tâm Thành phố Hồ Chí Minh": infographicBuuDienTrungTam,
  ...
  "CHỢ BẾN THÀNH-TPHCM": infographicChoBenThanh,
  "CHỢ BẾN THÀNH": infographicChoBenThanh,
...
export const LANDMARK_HOTSPOTS: Record<string, InfographicHotspot[]> = {
  ...
  "BƯU ĐIỆN TRUNG TÂM SÀI GÒN": [
    { id: 1, x: 50, y: 20, title: "Mặt Tiền Đồng Hồ Cổ Kính", category: "Kiến trúc", description: "Chiếc đồng hồ tròn lớn trên đỉnh cổng chính với hoa văn chạm khắc tinh xảo phong cách Phục Hưng Đông Dương.", tag: "Mặt đứng" },
    { id: 2, x: 50, y: 46, title: "Mái Vòm Khung Sắt Eiffel", category: "Kỹ thuật", description: "Hệ vòm sắt uốn cong thanh thoát cao 15.5m do kỹ sư bậc thầy Gustave Eiffel tính toán kết cấu chịu lực.", tag: "Kiệt tác" },
    { id: 3, x: 24, y: 62, title: "Bản Đồ Cổ Sài Gòn & Nam Kỳ 1892", category: "Văn hóa", description: "Hai bức họa lịch sử nguyên bản trên vòm tường mô tả mạng lưới điện báo và địa lý Sài Gòn xưa.", tag: "Tư liệu khảo cứu" },
    { id: 4, x: 76, y: 68, title: "Hàng Bốt Điện Thoại Gỗ Cổ Điển", category: "Văn hóa", description: "14 cabin điện thoại bằng gỗ tếch màu trầm lưu dấu nhịp sống viễn thông hơn một thế kỷ.", tag: "Ký ức đô thị" },
    { id: 5, x: 50, y: 82, title: "Bảng Danh Nhân Khoa Học & Viễn Thông", category: "Lịch sử", description: "Dưới các ô cửa vòm là tên các nhà phát minh vĩ đại (Ampère, Ohm, Volta, Morse, Faraday, Galvani...).", tag: "Tri thức" }
  ],
  "CHÙA HỘI KHÁNH-BÌNH DƯƠNG": [
...
export const PLACE_KEY_MAPPINGS: Record<string, { info: string; img: string; hot: string; blue: string }> = {
  ...
  "Bưu điện Trung tâm": { info: "BƯU ĐIỆN TRUNG TÂM SÀI GÒN", img: "BƯU ĐIỆN TRUNG TÂM SÀI GÒN", hot: "BƯU ĐIỆN TRUNG TÂM SÀI GÒN", blue: "BƯU ĐIỆN TRUNG TÂM SÀI GÒN" },
  "BƯU ĐIỆN TRUNG TÂM": { info: "BƯU ĐIỆN TRUNG TÂM SÀI GÒN", img: "BƯU ĐIỆN TRUNG TÂM SÀI GÒN", hot: "BƯU ĐIỆN TRUNG TÂM SÀI GÒN", blue: "BƯU ĐIỆN TRUNG TÂM SÀI GÒN" },
  "Bưu điện Thành phố": { info: "BƯU ĐIỆN TRUNG TÂM SÀI GÒN", img: "BƯU ĐIỆN TRUNG TÂM SÀI GÒN", hot: "BƯU ĐIỆN TRUNG TÂM SÀI GÒN", blue: "BƯU ĐIỆN TRUNG TÂM SÀI GÒN" },
  "Trung tâm Thành phố Hồ Chí Minh": { info: "BƯU ĐIỆN TRUNG TÂM SÀI GÒN", img: "BƯU ĐIỆN TRUNG TÂM SÀI GÒN", hot: "BƯU ĐIỆN TRUNG TÂM SÀI GÒN", blue: "BƯU ĐIỆN TRUNG TÂM SÀI GÒN" },
  "Địa danh trung tâm thành phố Hồ Chí Minh": { info: "BƯU ĐIỆN TRUNG TÂM SÀI GÒN", img: "BƯU ĐIỆN TRUNG TÂM SÀI GÒN", hot: "BƯU ĐIỆN TRUNG TÂM SÀI GÒN", blue: "BƯU ĐIỆN TRUNG TÂM SÀI GÒN" },
