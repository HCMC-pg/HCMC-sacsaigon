...
export const PlaceCard: React.FC<PlaceCardProps> = ({
  ...
  return (
    <div 
      ...
      className="group relative bg-[#131b2a] hover:bg-[#182337] rounded-xl border border-slate-800 hover:border-[#c29b38]/60 transition-all duration-300 flex flex-col overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-[#c29b38]/10 cursor-pointer transform-gpu hover:-translate-y-1 will-change-transform"
    ...
    >
      ...
      <div className="relative h-48 sm:h-52 w-full overflow-hidden bg-slate-900">
        <img 
          ...
          alt={place.name}
          className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500 brightness-90 contrast-105 transform-gpu"
          loading="lazy"
          decoding="async"
        />
