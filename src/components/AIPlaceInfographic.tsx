        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          {activeMode === 'metrics' && (
            <div className="p-5 rounded-2xl bg-[#141d2e] border border-slate-800 space-y-5">
              ...
              {/* Heritage Status & Age Timeline */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center">
                
                {/* Heritage Classification Card */}
                <div className="p-4 rounded-xl bg-[#0f1726] border border-slate-800 flex items-center gap-4">
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#c29b38]/20 to-[#e6ca65]/10 border border-[#c29b38]/40 shrink-0 flex items-center justify-center text-[#e6ca65] shadow-inner">
                    <Award className="w-8 h-8 text-[#e6ca65]" />
                  </div>

                  <div>
                    <span className="text-[10px] font-bold text-[#c29b38] uppercase tracking-wider block">Phân cấp xếp hạng:</span>
                ...
                <div className="p-4 rounded-xl bg-[#0f1726] border border-slate-800 space-y-2">
                  ...
                  <div className="w-full bg-slate-800 h-2.5 rounded-full overflow-hidden">
                    <div 
                      className="bg-gradient-to-r from-[#c29b38] to-[#e6ca65] h-full rounded-full transition-all duration-700"
                  ...
                  <div className="flex items-center justify-between text-[10px] text-slate-400 font-mono">
                    ...
                    <span className="text-slate-300 font-medium">Tiến trình lịch sử</span>
                    <span>Hiện đại</span>
                  </div>
